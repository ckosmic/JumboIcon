...
namespace JumboIcon
{
	public class IconSaver
	{
		...
		//public static string filePath = @"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe";
		...
		static void Main(string[] args)
		{
			...
			Bitmap bmp = GetJumboIcon(args[0]);
			bmp.Save("icons/" + fileName + ".png", System.Drawing.Imaging.ImageFormat.Png);
			bmp.Dispose();
		}
	}
}
